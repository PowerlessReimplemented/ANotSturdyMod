...
public class ModItems {
	 ...
	 *
	 * @param registry_names    (String[]) The registryName that will be given to
	 *                          the items.
	 * @param unlocalized_names (String[]) The unlocalizedName that will be given to
	 *                          the items.
	 * @param tab               (CreativeTabs) creative tab that items will belong
	 *                          to.
	 *
	 * @throws IllegalArguments When registry_names.length does not equal to
	 *                          unlocalized_names.length. (didn't give enough
	 *                          information to register all items)
	 */
