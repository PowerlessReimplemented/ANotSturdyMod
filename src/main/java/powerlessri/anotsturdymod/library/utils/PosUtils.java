...
public class PosUtils {
    ...
    /**
     * Get all blocks on a plane with {@code radius} * 2 + 1 side length, parallel with {@code sideHit}. <br />
     * 
     ...
     */
    public static Iterable<BlockPos> blocksOnPlane(BlockPos originalPos, EnumFacing sideHit, int radius) {
        switch(sideHit) {
        case UP:
        case DOWN:
