...
public class TextField extends AbstractComponent implements IInteractionHandler, IOnOffState {
    ...
    private void drawBackground(GuiDrawBackgroundEvent event) {
    }

    private void drawText(GuiDrawBackgroundEvent event) {
    }

    private void drawCursor(GuiDrawBackgroundEvent event) {
    }

    private void drawSelectionBox(GuiDrawBackgroundEvent event) {
    }
