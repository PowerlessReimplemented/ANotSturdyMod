...
public interface IInteractionHandler extends IComponent {
     ...
     * </ol>
     * </p>
     * <p>Return {@link ActionResultType#FAIL} to cancel the bubble up process</p>
     */
    ActionResultType onClicked(int mouseX, int mouseY, EMouseButton button, EEventType type);
     ...
     * If this method returns {@link ActionResultType#FAIL} when the parameter {@code type} is ORIGINAL,
     * the event bubbling process will be canceled.
     * </p>
     */
    ActionResultType onReleased(int mouseX, int mouseY, EMouseButton button, EEventType type);
