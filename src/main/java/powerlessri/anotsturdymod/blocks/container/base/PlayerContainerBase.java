package powerlessri.anotsturdymod.blocks.container.base;
 ...
 * Gives
 */
public abstract class PlayerContainerBase extends Container {
    ...
    public PlayerContainerBase(EntityPlayer player) {
        this.player = player;
    }
