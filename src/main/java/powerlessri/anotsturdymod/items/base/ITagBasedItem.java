...
public interface ITagBasedItem {
	...
	/**
	 * Set the tag of the given {@code stack} to the default state, but keep the ones that already exists. <br />
	 * 
	 * <b>NOTE</b>: this method should have situations that the stack doesn't have a NBT tag (null).
	 */
